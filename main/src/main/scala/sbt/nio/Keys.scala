...
object Keys {
  ...
  val fileInputs: SettingKey[Seq[Glob]] = settingKey[Seq[Glob]](
  ...
  val inputFileStamper: SettingKey[FileStamper] = settingKey[FileStamper](
  ...
  val fileOutputs: SettingKey[Seq[Glob]] =
    settingKey[Seq[Glob]]("Describes the output files of a task.")
  ...
  val outputFileStamper: SettingKey[FileStamper] = settingKey[FileStamper](
    "Toggles the file stamping implementation used to determine whether or not a file has been modified."
  )

  val fileTreeView: TaskKey[FileTreeView.Nio[FileAttributes]] =
  ...
  val watchAntiEntropyRetentionPeriod: SettingKey[FiniteDuration] = settingKey[FiniteDuration](
  ...
  val watchAntiEntropyPollPeriod: SettingKey[FiniteDuration] = settingKey[FiniteDuration](
    "The duration for which sbt will poll for file events during the window in which sbt is buffering file events"
  )
  val onChangedBuildSource: SettingKey[WatchBuildSourceOption] = settingKey[WatchBuildSourceOption](
    "Determines what to do if the sbt meta build sources have changed"
  ).withRank(DSetting)

  val watchDeletionQuarantinePeriod: SettingKey[FiniteDuration] = settingKey[FiniteDuration](
  ...
  // watch related keys
  val watchBeforeCommand: SettingKey[() => Unit] = settingKey[() => Unit](
  ...
  val watchInputOptionsMessage: SettingKey[String] =
    settingKey[String]("The help message for the watch input options")
  val watchInputOptions: SettingKey[Seq[Watch.InputOption]] =
    settingKey[Seq[Watch.InputOption]]("The available input options")
  val watchInputStream: TaskKey[InputStream] = taskKey[InputStream](
    "The input stream to read for user input events. This will usually be System.in"
  ).withRank(DSetting)
  val watchInputParser: SettingKey[Parser[Watch.Action]] = settingKey[Parser[Watch.Action]](
    "A parser of user input that can be used to trigger or exit a continuous build"
  ).withRank(DSetting)
  val watchLogLevel: SettingKey[Level.Value] =
  ...
  val watchOnFileInputEvent: SettingKey[(Int, Watch.Event) => Watch.Action] =
    settingKey[(Int, Watch.Event) => Watch.Action](
  ...
  val watchOnIteration: SettingKey[(Int, ProjectRef, Seq[String]) => Watch.Action] =
    settingKey[(Int, ProjectRef, Seq[String]) => Watch.Action](
  ...
  val watchOnTermination: SettingKey[(Watch.Action, String, Int, State) => State] =
    settingKey[(Watch.Action, String, Int, State) => State](
  ...
  val watchPersistFileStamps: SettingKey[Boolean] = settingKey[Boolean](
  ...
  val watchStartMessage: SettingKey[(Int, ProjectRef, Seq[String]) => Option[String]] =
    settingKey[(Int, ProjectRef, Seq[String]) => Option[String]](
  ...
  val watchTasks: InputKey[StateTransform] = InputKey[StateTransform](
    "watch",
  ...
  val watchTriggeredMessage: SettingKey[(Int, Path, Seq[String]) => Option[String]] =
    settingKey[(Int, Path, Seq[String]) => Option[String]](
