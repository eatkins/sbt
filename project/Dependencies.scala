...
object Dependencies {
  ...
  val ipcSocket = "org.scala-sbt.ipcsocket" % "ipcsocket" % "1.0.1-SNAPSHOT"
  ...
  val jline2 = "org.scala-sbt.jline" % "jline" % "2.14.7-sbt-c795034540e2460f2a2b4c22acce8e2511b15522"
